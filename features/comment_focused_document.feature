...
Scénario: Une glose dont je suis l'auteur est ouverte
  ...
  Et un document dont je suis l'auteur affiché comme glose
  ...
  Et je peux lire "plusieurs personnes se présentent à moi. Ayant identifié que je suis nouveau, elles me souhaitent la bienvenue:"
