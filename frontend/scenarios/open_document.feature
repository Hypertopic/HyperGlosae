...
Fonctionnalité: Ouvrir à côté d'une source

Scénario: une traduction passage par passage
  ...
  Quand j'ouvre "Víly (Charles Perrault)" à côté
  Alors je peux lire "Bola raz jedna vdova, ktorá mala dve dcéry"
  Et je peux lire "Il était une fois une veuve qui avait deux filles"
  Mais je ne peux pas lire "Volt egyszer egy özvegyasszony"

Scénario: un commentaire fragment par fragment
  ...
  Quand j'ouvre "Étiquetage de l'entretien" à côté
...
Scénario: un commentaire global
  ...
  Quand j'ouvre "Analyse de l'entretien" à côté
...
Scénario: une comparaison avec des documents apparentés
  ...
  Quand j'ouvre "Soleil noir et étoiles qui tombent – Comparaison de vitraux" à côté
  ...
  Et l'image intégrée dans la page a pour légende "Photographie : vitrail, baie 113, Église Saint-Nizier, Troyes"
  Et l'image intégrée dans la page a pour légende "Photographie : vitrail, baie 6, Église Saint-Martin-ès-Vignes, Troyes"
  Et l'image intégrée dans la page a pour légende "Photographie : vitrail, baie 5, Église Saint-Martin, Grandville, Aube"
